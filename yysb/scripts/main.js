...
// // 在适当的时候移除点击事件监听器
// btnConnect.removeEventListener('click', start);
...
function getJsonMessage(jsonMsg) {
	...
	console.log(varArea.value);
	Asc.scope.text = varArea.value; // export variable to plugin scope
